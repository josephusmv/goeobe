...
const cTestTempIdxActionName = "GetIndex"
...
func doTestSmokeGetURLAndValidate(url string, expectedCode int, t *testing.T) {
	actionList := []string{cTestTempIdxActionName, "DoEchoTest", cTestTempDynamicActionName}
...
func createRequestServer(module string, templates, actionList []string, t *testing.T) *RequestServer {
	...
	rfInf = rspFcther
	rs := NewRequestServer(module, cTestStrhtmlRoot, cTestTempIdxActionName, &rfInf, nil)

...
const cStrFileNameNotFoundinUploadListError = "File: %s Not Found in upload list"
const cStrFileBytesAreNil = "Empty uploaded file list."
...
const cStrFetchRespError = "RemoteEncrypt: Error when fetch response: %v"
